...
export function UsageChargeConfigViewIDs () {return ["id_usageCharge", "id_paymentMode"];} 
export function PreFlushConfigViewIDs () {return ["id_autoPreFlush"];}
export function MiniFlushConfigViewIDs () {return ["id_autoMiniFlush", "id_FlushDuration","id_activationDelay"];} 
export function FullFlushConfigViewIDs () {return ["id_autoFullFlush", "id_FlushDuration","id_activationDelay"];} 
export function FloorCleanConfigViewIDs () {return ["id_autoFloorClean", "id_floorCleanCount","id_floorCleanDuration"];} 
export function LightConfigViewIDs () {return ["id_autoLight", "id_autoOffTime","id_autoOnTime"];} 
export function FanConfigViewIDs () {return ["id_autoFan", "id_autoOffTime","id_autoOnTime"];} 
    ...
    <table style={{ width: "100%" , overflowX:'scroll'}}>
            <tbody>
              <tr >
                <td style={{ width: '50%' }}>
                  <div >
                  <DataRequestLabel label={"HEALTH_LIGHT"} isSelected = {false} handleUpdate={props.handleUpdate} />
                  </div>
                </td>
  ...
  return (
    <div
      ...
      >
        ...
        label={props.label} 
        selected ={false} 
        onChange={(e)=>{setSelected(e);  props.handleUpdate(e)}}
        />
    ...
    <div
      ...
      >
        <Dropdown
          ...
          onSelection={(index, value) => { setEnabled(value); props.handleUpdate(props.configTab,props.id,value) }}
        />
    ...
    <div
      ...
      >
        <RxInputText
          text={props.value}
          placeholder={''}
          onChange={(text) => { props.handleUpdate(props.configTab,props.id,text) }}
        />
